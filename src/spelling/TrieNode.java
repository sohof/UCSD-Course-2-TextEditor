...
class TrieNode {
	...
	/** Inserts this character at this node. Returns the newly created node, if c wasn't already
	 * in the trie.  If it was, it does not modify the trie and returns null.
